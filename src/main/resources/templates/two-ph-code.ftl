          ...
          <![endif]-->
                            ...
                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://64.media.tumblr.com/35578b7651c6579e680278ac00e76924/tumblr_pfb90w6ABd1uw920co1_1280.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;padding-bottom:20px;">

                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                                Hello ${name}, here is ${text} you have just requested..
                                            </div>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                              If you did not make this request, please change your password as soon as possible!
                                            </div>

                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://64.media.tumblr.com/35578b7651c6579e680278ac00e76924/tumblr_pfb90w6ABd1uw920co1_1280.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="80" />
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                Hello ${name}, It seems that you’ve forgotten your password.
                                            </div>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                               New password: ${newPassword}<br><br>If you did not make this request, just ignore this email. Otherwise please click the button above to reset your password.
                                            </div>
